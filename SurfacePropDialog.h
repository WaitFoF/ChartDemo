...
// Dialog Data
	...
	int		m_iHorizSurf;//水平，还是垂直画
	int		m_FillStyle;//线型:Solid;Hatch down diagonal;Hatch up diagonal;Hatch cross;Hatch cross diagonal ;Hatch horizontal;Hatch vertical;
	//}}AFX_DATA
